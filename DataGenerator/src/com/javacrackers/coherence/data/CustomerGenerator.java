package com.javacrackers.coherence.data;

import java.util.ArrayList;
import java.util.List;
import java.util.Random;

import com.javacrackers.coherence.customers.Customer;
...
public class CustomerGenerator {
	...
	public String getRandomCountry() {
		String[] countries = { "England", "Italy", "Turkey", "France", "Spain", "Japan", "Greece", "Germany", "USA" };
	...
	public List<Customer> getCustomers(int customersSize) {
		...
		for (int i = 0; i < customersSize; i++) {
			Customer customer = new Customer(Integer.toString(i), getRandomFirstName(), getRandomLastName(),
					getRandomCountry(), getRandomZipCode(), getRandomCitizenNo(), getRandomAge());
	...
	public List<Customer> getCustomers(int customersSize, int startIndex) {
		...
		for (int i = 0; i < customersSize; i++) {
			Customer customer = new Customer(Integer.toString(i + startIndex), getRandomFirstName(),
					getRandomLastName(), getRandomCountry(), getRandomZipCode(), getRandomCitizenNo(), getRandomAge());
			customers.add(customer);
		}
	...
	public Customer getCustomer(int customerId) {
		...
		Customer customer = new Customer(Integer.toString(customerId), getRandomFirstName(), getRandomLastName(),
				getRandomCountry(), getRandomZipCode(), getRandomCitizenNo(), getRandomAge());
		return customer;
	}
